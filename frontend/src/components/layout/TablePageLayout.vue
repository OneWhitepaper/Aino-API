...
.table-page-layout {
  ...
  height: calc(100vh - 80px - 4rem); /* Header + lg:p-8 */
}
...
.table-scroll-container {
  @apply flex flex-col overflow-hidden h-full bg-white dark:bg-dark-900 rounded-2xl border border-gray-200 dark:border-dark-700 shadow-card;
}
