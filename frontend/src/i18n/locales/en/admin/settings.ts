export default {
    settings: {
      desktop: {
        search: "Search names, model IDs or groups",
        modelCount: "{count} models",
        expandAll: "Expand all",
        collapseAll: "Collapse all",
        noMatches: "No matching models",
        verifiedShort: "Verified",
        unverifiedShort: "Not verified",
        import: {
          open: 'Discover models',
          title: 'Import from an existing source',
          description: 'Choose a group and source account to fetch models using its configured connection. No API key re-entry is needed. Discovery also refreshes the source account capability cache.',
          account: 'Source account',
          noAccounts: 'No source accounts in this group. Link an account in Account Management, or add models manually.',
          accountsFailed: 'Could not load source accounts. Please retry.',
          fetch: 'Fetch model list',
          fetching: 'Fetching…',
          fetchFailed: 'Could not fetch models. Check the source account, connection and upstream model-list support, then retry. Manual entry is still available.',
          metadataWarning: 'Some metadata is incomplete, or configured models were used as a fallback. Review imported entries and fill in missing details.',
          search: 'Search models to import',
          selectAll: 'Select filtered models',
          clearSelection: 'Clear selection',
          count: '{total} fetched, {selected} selected, room for {remaining} more',
          reviewHint: 'Fill model IDs, names and returned metadata automatically. Existing entries are skipped and group pricing applies. Confirm actual tool support and Agent behavior; imported models remain unverified.',
          limit: 'The catalog supports 200 models. Select at most {remaining} more.',
          confirm: 'Import selected ({count})',
          success: 'Added {count} models to this form. Review them and save settings.',
          exists: 'Already added for this group and protocol',
          notAllowed: 'Not permitted by this group allowlist',
        },
